      ...
      <div className='container mx-auto px-4 pt-20 sm:px-6 lg:px-8'>
        <main className='flex items-center justify-center'>
          <article className=' flex-[2] space-y-8 max-w-3xl flex flex-col justify-center'>
            ...
            <p className='text-base md:text-gray-600'>
              Nós somos uma plataforma para profissionais da saúde com foco em agilizar seu atendimento de forma
              simplificada e organizada.
            </p>
            <Button className='bg-emerald-500 hover:bg-emerald-600 text-white w-fit px-6 font-semibold'>Profissionais disponíveis</Button>
          </article>
          <div className='hidden lg:block'>
            <Image
              className='object-contain'
              src={doctorImage}
              alt='Foto ilustrativa de um medico.'
              width={340}
              height={400}
              quality={100}
              priority
